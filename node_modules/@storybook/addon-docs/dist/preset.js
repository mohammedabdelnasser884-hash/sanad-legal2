import CJS_COMPAT_NODE_URL_se3exj559cj from 'node:url';
import CJS_COMPAT_NODE_PATH_se3exj559cj from 'node:path';
import CJS_COMPAT_NODE_MODULE_se3exj559cj from "node:module";

var __filename = CJS_COMPAT_NODE_URL_se3exj559cj.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_se3exj559cj.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_se3exj559cj.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-WV6KK5Z6.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-SSWATMLH.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-C4VUQH3I.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-ENB56UY3.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
