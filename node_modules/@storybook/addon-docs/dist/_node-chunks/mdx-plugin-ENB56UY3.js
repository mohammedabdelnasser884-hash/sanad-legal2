...
import {
  compile
} from "./chunk-HIBBQOJC.js";
import "./chunk-H2U3C3YH.js";
import "./chunk-WRTDEVEV.js";
import {
  __commonJS,
  __toESM
} from "./chunk-WV6KK5Z6.js";
...
async function mdxPlugin(options) {
  let include = /\.mdx$/, filter = createFilter(include), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-SSWATMLH.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-C4VUQH3I.js")).default;
  return {
