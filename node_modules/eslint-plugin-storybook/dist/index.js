import CJS_COMPAT_NODE_URL_kogkc32qfml from 'node:url';
import CJS_COMPAT_NODE_PATH_kogkc32qfml from 'node:path';
import CJS_COMPAT_NODE_MODULE_kogkc32qfml from "node:module";

var __filename = CJS_COMPAT_NODE_URL_kogkc32qfml.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_kogkc32qfml.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_kogkc32qfml.createRequire(import.meta.url);
...
// package.json
var name = "eslint-plugin-storybook", version = "10.5.10";
...
// ../../core/src/csf/toStartCaseStr.ts
...
var prefer_pascal_case_default = createStorybookRule({
  ...
  create(context) {
    let isPascalCase = (str) => /^[A-Z]+([a-z0-9]?)+/.test(str), toPascalCase = (str) => str.replace(new RegExp(/[-_]+/, "g"), " ").replace(new RegExp(/[^\w\s]/, "g"), "").replace(
      ...
      let { name: name2 } = id;
      if (!isExportStory(name2, nonStoryExportsConfig2) || name2 === "__namedExportsOrder")
        return null;
