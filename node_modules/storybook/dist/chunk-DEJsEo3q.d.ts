...
type SBType$1 = SBScalarType | SBEnumType | SBArrayType | SBNodeType | SBObjectType | SBIntersectionType | SBUnionType | SBLiteralType | SBTupleType | SBOtherType;
//#endregion
...
interface InputType {
  ...
  type?: SBType$1 | SBScalarType['name'];
  /**
...
type ArgTypes$2<TArgs = Args$2> = { [name in keyof TArgs]: InputType };
type StrictArgTypes$2<TArgs = Args$2> = { [name in keyof TArgs]: StrictInputType };
interface Globals$2 {
  [name: string]: any;
}
 ...
 */
interface AddonTypes$1 {
  tags?: Tag$2[] | undefined;
  args?: unknown;
  parameters?: Record<string, any>;
  globals?: Record<string, any>;
}
interface Renderer$2 extends AddonTypes$1 {
...
type AnyFramework = Renderer$2;
interface StoryContextForEnhancers$1<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> extends StoryIdentifier {
  component?: (TRenderer & {
    T: any;
  })['component'];
  ...
  initialArgs: TArgs;
  argTypes: StrictArgTypes$2<TArgs>;
}
type ArgsEnhancer<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = (context: StoryContextForEnhancers$1<TRenderer, TArgs>) => TArgs;
type ArgTypesEnhancer<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = ((context: StoryContextForEnhancers$1<TRenderer, TArgs>) => StrictArgTypes$2<TArgs>) & {
  secondPass?: boolean;
};
interface StoryContextUpdate$1<TArgs = Args$2> {
  args?: TArgs;
  globals?: Globals$2;
  [key: string]: any;
}
type ViewMode$2 = 'story' | 'docs';
type LoaderFunction<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = (context: StoryContextForLoaders<TRenderer, TArgs>) => Promise<Record<string, any> | void> | Record<string, any> | void;
type Awaitable<T> = T | PromiseLike<T>;
type CleanupCallback$1 = () => Awaitable<unknown>;
type BeforeAll = () => Awaitable<CleanupCallback$1 | void>;
type BeforeEach<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = (context: StoryContext$2<TRenderer, TArgs>) => Awaitable<CleanupCallback$1 | void>;
type AfterEach<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = (context: StoryContext$2<TRenderer, TArgs>) => Awaitable<void>;
interface Canvas extends BoundFunctions<typeof queries> {}
interface StoryContext$2<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> extends StoryContextForEnhancers$1<TRenderer, TArgs>, Required<StoryContextUpdate$1<TArgs>> {
...
interface StoryContextForLoaders<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> extends StoryContext$2<TRenderer, TArgs> {}
/** @deprecated Use {@link StoryContext} instead. */
interface PlayFunctionContext<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> extends StoryContext$2<TRenderer, TArgs> {}
type StepLabel = string;
type StepFunction<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = (label: StepLabel, play: PlayFunction<TRenderer, TArgs>) => Promise<void> | void;
type PlayFunction<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = (context: PlayFunctionContext<TRenderer, TArgs>) => Promise<void> | void;
type TestFunction$1<TRenderer extends Renderer$2 = Renderer$2, TArgs = TRenderer['args']> = (context: StoryContext$2<TRenderer, TArgs>) => Promise<void> | void;
type PartialStoryFn$1<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = (update?: StoryContextUpdate$1<Partial<TArgs>>) => TRenderer['storyResult'];
type LegacyStoryFn$1<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = (context: StoryContext$2<TRenderer, TArgs>) => TRenderer['storyResult'];
type ArgsStoryFn<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = (args: TArgs, context: StoryContext$2<TRenderer, TArgs>) => (TRenderer & {
  T: TArgs;
})['storyResult'];
type StoryFn<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = LegacyStoryFn$1<TRenderer, TArgs> | ArgsStoryFn<TRenderer, TArgs>;
type DecoratorFunction$2<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = (fn: PartialStoryFn$1<TRenderer, TArgs>, c: StoryContext$2<TRenderer, TArgs>) => TRenderer['storyResult'];
type DecoratorApplicator$1<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = (storyFn: LegacyStoryFn$1<TRenderer, TArgs>, decorators: DecoratorFunction$2<TRenderer, TArgs>[]) => LegacyStoryFn$1<TRenderer, TArgs>;
type StepRunner$1<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = (label: StepLabel, play: PlayFunction<TRenderer, TArgs>, context: StoryContext$2<TRenderer, TArgs>) => Promise<void>;
interface BaseAnnotations<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> {
  /**
   ...
   */
  decorators?: DecoratorFunction$2<TRenderer, Simplify<TArgs>>[] | DecoratorFunction$2<TRenderer, Simplify<TArgs>>;
  /**
   ...
   */
  argTypes?: Partial<ArgTypes$2<TArgs>>;
  /**
  ...
  tags?: (TRenderer['tags'] extends Tag$2[] ? TRenderer['tags'] : Tag$2[]) | undefined;
  mount?: (context: StoryContext$2<TRenderer, TArgs>) => TRenderer['mount'];
}
interface ProjectAnnotations$2<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> extends BaseAnnotations<TRenderer, TArgs> {
  argsEnhancers?: ArgsEnhancer<TRenderer, Args$2>[];
  argTypesEnhancers?: ArgTypesEnhancer<TRenderer, Args$2>[];
  /**
   ...
   */
  beforeAll?: BeforeAll;
  initialGlobals?: Globals$2 & (TRenderer['csf4'] extends true ? CoreTypes['globals'] & TRenderer['globals'] : unknown);
  globalTypes?: GlobalTypes$1;
  applyDecorators?: DecoratorApplicator$1<TRenderer, Args$2>;
  runStep?: StepRunner$1<TRenderer, TArgs>;
}
type StoryDescriptor = string[] | RegExp;
interface ComponentAnnotations$1<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> extends BaseAnnotations<TRenderer, TArgs> {
  /**
  ...
  globals?: Partial<Globals$2 & (TRenderer['csf4'] extends true ? CoreTypes['globals'] & TRenderer['globals'] : unknown)>;
}
type StoryAnnotations$1<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2, TRequiredArgs = Partial<TArgs>> = BaseAnnotations<TRenderer, TArgs> & {
  ...
  globals?: Partial<Globals$2 & (TRenderer['csf4'] extends true ? CoreTypes['globals'] & TRenderer['globals'] : unknown)>; /** @deprecated */
...
type LegacyAnnotatedStoryFn<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = StoryFn<TRenderer, TArgs> & StoryAnnotations$1<TRenderer, TArgs>;
type LegacyStoryAnnotationsOrFn$1<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = LegacyAnnotatedStoryFn<TRenderer, TArgs> | StoryAnnotations$1<TRenderer, TArgs>;
type AnnotatedStoryFn<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = ArgsStoryFn<TRenderer, TArgs> & StoryAnnotations$1<TRenderer, TArgs>;
type StoryAnnotationsOrFn$1<TRenderer extends Renderer$2 = Renderer$2, TArgs = Args$2> = AnnotatedStoryFn<TRenderer, TArgs> | StoryAnnotations$1<TRenderer, TArgs>;
type ArgsFromMeta<TRenderer extends Renderer$2, Meta> = Meta extends {
...
type DecoratorsArgs<TRenderer extends Renderer$2, Decorators> = UnionToIntersection<Decorators extends DecoratorFunction$2<TRenderer, infer TArgs> ? TArgs : unknown>;
type LoaderArgs<TRenderer extends Renderer$2, Loaders> = UnionToIntersection<Loaders extends LoaderFunction<TRenderer, infer TArgs> ? TArgs : unknown>;
//#endregion
export { Tag$2 as $, PartialStoryFn$1 as A, StoryContext$2 as B, Globals$2 as C, Simplify as Ct, LegacyStoryFn$1 as D, LegacyStoryAnnotationsOrFn$1 as E, StepFunction as F, StoryId$2 as G, StoryContextForLoaders as H, StepLabel as I, StoryName$1 as J, StoryIdentifier as K, StepRunner$1 as L, PlayFunctionContext as M, ProjectAnnotations$2 as N, LoaderFunction as O, Renderer$2 as P, StrictParameters as Q, StoryAnnotations$1 as R, GlobalTypes$1 as S, OmitIndexSignature as St, LegacyAnnotatedStoryFn as T, StoryContextUpdate$1 as U, StoryContextForEnhancers$1 as V, StoryFn as W, StrictArgs as X, StrictArgTypes$2 as Y, StrictInputType as Z, ComponentId as _, SBOtherType as _t, ArgTypes$2 as a, markAsComposedWithCoreAnnotations as at, DecoratorApplicator$1 as b, SBType$1 as bt, ArgsEnhancer as c, MeasureTypes as ct, BaseAnnotations as d, SBArrayType as dt, TestFunction$1 as et, BeforeAll as f, SBEnumType as ft, ComponentAnnotations$1 as g, SBObjectType as gt, CleanupCallback$1 as h, SBNodeType as ht, AnyFramework as i, hasCoreAnnotations as it, PlayFunction as j, Parameters$1 as k, ArgsFromMeta as l, ControlsTypes as lt, Canvas as m, SBLiteralType as mt, AfterEach as n, CoreTypes as nt, ArgTypesEnhancer as o, TestTypes as ot, BeforeEach as p, SBIntersectionType as pt, StoryKind as q, AnnotatedStoryFn as r, getCoreAnnotations as rt, Args$2 as s, OutlineTypes as st, AddonTypes$1 as t, ViewMode$2 as tt, ArgsStoryFn as u, ActionsTypes as ut, ComponentTitle$1 as v, SBScalarType as vt, InputType as w, UnionToIntersection as wt, DecoratorFunction$2 as x, SBUnionType as xt, Conditional as y, SBTupleType as yt, StoryAnnotationsOrFn$1 as z };