...
import "./chunk-VJTW7TTL.js";
import "./chunk-JRKUMY2M.js";
import {
  styled
} from "./chunk-KIF45B55.js";
import "./chunk-6DM5GRGB.js";
...
// node_modules/@storybook/addon-docs/dist/_browser-chunks/Color-6AOWCN3U.js
...
var usePresets = (presetColors, currentColor, colorSpace, maxPresetColors = 27) => {
  ...
  }, [presetColors, selectedColors, maxPresetColors]), addPreset = (0, import_react.useCallback)(
    (color) => {
...
var ColorControl = ({
  ...
  let debouncedOnChange = (0, import_react.useCallback)(debounce(onChange, 200), [onChange]), { value, realValue, updateValue, color, colorSpace, cycleColorSpace } = useColorInput(
    initialValue,
    debouncedOnChange
  ), { presets, addPreset } = usePresets(presetColors ?? [], color, colorSpace, maxPresetColors), Picker = ColorPicker[colorSpace], readOnly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly), controlId = getControlId(name, storyId, controlsId);
...
//# sourceMappingURL=Color-6AOWCN3U-KTN5TL63.js.map
