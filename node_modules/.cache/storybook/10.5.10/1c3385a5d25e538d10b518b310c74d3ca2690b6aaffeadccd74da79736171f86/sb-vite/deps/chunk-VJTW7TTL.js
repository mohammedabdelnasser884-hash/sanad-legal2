...
function $319e236875307eab$export$a9b970dcc4ae71a9(message, assertiveness = "assertive", timeout = 7e3) {
  $319e236875307eab$var$liveAnnouncer ? $319e236875307eab$var$liveAnnouncer.announce(message, assertiveness, timeout) : ($319e236875307eab$var$liveAnnouncer = new $319e236875307eab$var$LiveAnnouncer(), (typeof IS_REACT_ACT_ENVIRONMENT == "boolean" ? IS_REACT_ACT_ENVIRONMENT : typeof jest < "u") ? $319e236875307eab$var$liveAnnouncer.announce(message, assertiveness, timeout) : setTimeout(() => {
    ($319e236875307eab$var$liveAnnouncer == null ? void 0 : $319e236875307eab$var$liveAnnouncer.isAttached()) && ($319e236875307eab$var$liveAnnouncer == null ? void 0 : $319e236875307eab$var$liveAnnouncer.announce(message, assertiveness, timeout));
  }, 100));
}
...
// node_modules/storybook/dist/_browser-chunks/chunk-W22LQPXL.js
...
var ActionBar = ({ actionItems, flexLayout = false, ...props }) => import_react.default.createElement(Container, { ...props, $flexLayout: flexLayout }, actionItems.map(({ title, ariaLabel, className, onClick, disabled }, index) => import_react.default.createElement(
  ActionButton,
  {
    key: index,
...
function useCopyButton({
  ...
  let [copied, setCopied] = (0, import_react3.useState)(false), timerRef = (0, import_react3.useRef)(null);
  ...
  let handleClick = (0, import_react3.useCallback)(
    (e) => {
      ...
      (_a = navigator.clipboard) == null ? void 0 : _a.writeText(content).then(() => {
        onCopy == null ? void 0 : onCopy(e), setCopied(true), $319e236875307eab$export$a9b970dcc4ae71a9(announcement, "polite"), timerRef.current = setTimeout(() => {
          setCopied(false), $319e236875307eab$export$d10ae4f68404609a("polite"), timerRef.current = null;
        }, duration);
      });
    },
  ...
  return {
    ...
    buttonProps: (0, import_react3.useMemo)(
      () => ({
        onClick: handleClick,
...
//# sourceMappingURL=chunk-VJTW7TTL.js.map
