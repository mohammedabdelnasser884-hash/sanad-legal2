...
var import_preview_errors4 = __toESM(require_preview_errors());
...
var import_preview_api5 = __toESM(require_preview_api2());
var import_react78 = __toESM(require_react());
var import_preview_errors5 = __toESM(require_preview_errors());
...
var import_core_events5 = __toESM(require_core_events());
...
var import_preview_api6 = __toESM(require_preview_api2());
var import_react90 = __toESM(require_react());
var import_client_logger6 = __toESM(require_client_logger());
var import_preview_errors6 = __toESM(require_preview_errors());
var import_react91 = __toESM(require_react());
var import_preview_errors7 = __toESM(require_preview_errors());
var import_react92 = __toESM(require_react());
var import_client_logger7 = __toESM(require_client_logger());
...
var import_client_logger8 = __toESM(require_client_logger());
...
var CheckboxControl = ({
  ...
  return import_react11.default.createElement(Wrapper22, { $isInline: isInline }, import_react11.default.createElement("legend", { className: "sb-sr-only" }, name, required ? " (required)" : ""), Object.keys(options).map((key, index) => {
...
var RadioControl = ({
  ...
  let selection = selectedKey(value, options), controlId = getControlId(name, storyId, controlsId), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly);
  return import_react12.default.createElement(Wrapper3, { isInline }, import_react12.default.createElement("legend", { className: "sb-sr-only" }, name, required ? " (required)" : ""), Object.keys(options).map((key, index) => {
    let id = `${controlId}-${index}`;
...
var SingleSelect = ({
  ...
  }, selection = selectedKey(value, options) || NO_SELECTION, controlId = getControlId(name, storyId, controlsId), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly);
  return import_react13.default.createElement(SelectWrapper, null, import_react13.default.createElement(ChevronSmallDownIcon, null), import_react13.default.createElement("label", { htmlFor: controlId, className: "sb-sr-only" }, name), import_react13.default.createElement(
    OptionsSelect,
    {
      disabled: readonly,
      id: controlId,
    ...
    import_react13.default.createElement("option", { disabled: selection === NO_SELECTION, key: "no-selection" }, NO_SELECTION),
...
var MultiSelect = ({
  ...
  }, selection = selectedKeys(value, options), controlId = getControlId(name, storyId, controlsId), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly);
...
var ObjectControl = ({
  ...
  var _a;
  let data = (0, import_react14.useMemo)(() => value && cloneDeep(value), [value]), hasData = data != null, [showRaw, setShowRaw] = (0, import_react14.useState)(!hasData), hadDataRef = (0, import_react14.useRef)(hasData), [parseError, setParseError] = (0, import_react14.useState)(null), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly), updateRaw = (0, import_react14.useCallback)(
    (raw) => {
      try {
  ...
  (0, import_react14.useEffect)(() => {
    !hadDataRef.current && hasData && showRaw && !forceVisible && setShowRaw(false), hadDataRef.current = hasData;
  }, [forceVisible, hasData, showRaw]);
  let htmlElRef = (0, import_react14.useRef)(null);
  (0, import_react14.useEffect)(() => {
    forceVisible && htmlElRef.current && htmlElRef.current.select();
  }, [forceVisible]);
  ...
  let rawInputId = getControlId(name, storyId, controlsId), rawJSONForm = import_react14.default.createElement(import_react14.default.Fragment, null, import_react14.default.createElement("label", { htmlFor: rawInputId, className: "sb-sr-only" }, "Edit ", name, " as JSON"), import_react14.default.createElement(
    RawInput,
    {
      ref: htmlElRef,
      id: rawInputId,
...
var RangeControl = ({
  ...
  }, hasValue = value !== void 0, numberOFDecimalsPlaces = (0, import_react18.useMemo)(() => getNumberOfDecimalPlaces(step), [step]), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly), controlId = getControlId(name, storyId, controlsId);
...
var LazyColorControl = (0, import_react6.lazy)(() => import("./Color-6AOWCN3U-KTN5TL63.js"));
...
var ArgControl = ({
  ...
  if (!control || control.disable)
    return (control == null ? void 0 : control.disable) !== true && ((_a = row == null ? void 0 : row.type) == null ? void 0 : _a.name) !== "function" ? import_react5.default.createElement(import_react5.default.Fragment, null, import_react5.default.createElement("span", { className: "sbdocs sbdocs-argcontrol-setup" }, import_react5.default.createElement(
      Link2,
      {
      ...
      "Setup controls"
    )), import_react5.default.createElement("span", { className: "sbdocs sbdocs-argcontrol-placeholder" }, import_react5.default.createElement(NoControl, null))) : import_react5.default.createElement(NoControl, null);
  let props = {
    name: key,
    storyId,
    controlsId,
...
var ArgRow = (props) => {
  var _a;
  let { row, updateArgs, compact: compact2, expandable, initialExpandedArgs, docsLang } = props, { name, description } = row, table = row.table || {}, type = table.type || toSummary(row.type), defaultValue = table.defaultValue || row.defaultValue, required = (_a = row.type) == null ? void 0 : _a.required, hasDescription = description != null && description !== "";
  return import_react4.default.createElement(StyledTr, null, import_react4.default.createElement(StyledTd, { expandable: expandable ?? false }, import_react4.default.createElement(Name, null, name), required ? import_react4.default.createElement(Required, { "aria-hidden": true, title: "Required" }, "*") : null), compact2 ? null : import_react4.default.createElement("td", null, hasDescription && import_react4.default.createElement(Description, { lang: docsLang }, import_react4.default.createElement(index_modern_default, null, description)), table.jsDocTags != null ? import_react4.default.createElement(import_react4.default.Fragment, null, import_react4.default.createElement(TypeWithJsDoc, { hasDescription }, import_react4.default.createElement(ArgValue, { value: type, initialExpandedArgs })), import_react4.default.createElement(ArgJsDoc, { tags: table.jsDocTags })) : import_react4.default.createElement(Type, { hasDescription }, import_react4.default.createElement(ArgValue, { value: type, initialExpandedArgs }))), compact2 ? null : import_react4.default.createElement("td", null, import_react4.default.createElement(ArgValue, { value: defaultValue, initialExpandedArgs })), updateArgs ? import_react4.default.createElement("td", null, import_react4.default.createElement(ArgControl, { ...props, isRequired: !!required })) : null);
};
...
var Empty = ({ inAddonPanel }) => {
  ...
  return (0, import_react23.useEffect)(() => {
    ...
    EmptyTabContent,
    {
      ...
      description: import_react23.default.createElement(import_react23.default.Fragment, null, "Storybook couldn't find or generate any controls for this story. Define", " ", import_react23.default.createElement("code", null, "args"), " or ", import_react23.default.createElement("code", null, "argTypes"), ", or configure docgen to let Storybook generate controls automatically."),
      footer: import_react23.default.createElement(Links, null, import_react23.default.createElement(
        Link2,
        {
          href: "https://storybook.js.org/docs/essentials/controls?ref=ui",
          target: "_blank",
...
var ArgsTable = (props) => {
  let {
    ...
    controlsId,
    docsLang
  } = props, { rows, args, globals } = "rows" in props ? props : { rows: void 0, args: void 0, globals: void 0 }, isResettingRef = (0, import_react3.useRef)(false), [isResetting, setIsResetting] = (0, import_react3.useState)(false);
  (0, import_react3.useEffect)(() => {
    isResettingRef.current = false, setIsResetting(false);
  }, [args]);
  let handleResetClick = (0, import_react3.useCallback)(() => {
    !isResettingRef.current && resetArgs && (isResettingRef.current = true, setIsResetting(true), resetArgs());
  }, [resetArgs]);
  if ("error" in props) {
    let { error } = props;
  ...
  return import_react3.default.createElement(ResetWrapper, null, import_react3.default.createElement(TablePositionWrapper, null, updateArgs && !isLoading && resetArgs && import_react3.default.createElement(ButtonPositionWrapper, null, import_react3.default.createElement(
    ...
    import_react3.default.createElement("tbody", { className: "docblock-argstable-body" }, groups.ungrouped.map((row) => import_react3.default.createElement(
      ArgRow,
      {
        key: row.key,
        row,
    ...
    )), Object.entries(groups.ungroupedSubsections).map(([subcategory, subsection]) => import_react3.default.createElement(
      SectionRow,
      {
        key: subcategory,
        label: subcategory,
...
var DocsPageWrapper = ({ children, toc, lang = "en" }) => import_react26.default.createElement(DocsWrapper, { className: "sbdocs sbdocs-wrapper" }, toc, import_react26.default.createElement(DocsContent, { className: "sbdocs sbdocs-content", lang }, children));
...
var getStoryId = (props, context) => {
  ...
  if ("of" in props && of === void 0)
    throw new import_preview_errors.InvalidBlockOfPropError();
...
var InlineStory = (props) => {
  ...
  return (0, import_react55.useEffect)(() => {
    ...
    props
  )} { min-height: ${height}; transform: translateZ(0); overflow: auto }`) : null, showLoader && import_react55.default.createElement(StorySkeleton, null), import_react55.default.createElement(
    "div",
    {
      ref: storyRef,
      id: `${storyBlockIdFromId(props)}-inner`,
      "data-name": story.name,
      lang: ((_a = story.parameters) == null ? void 0 : _a.htmlLang) || "en"
    }
  ));
};
...
var Toolbar2 = ({
  ...
  import_react58.default.createElement(Wrapper7, { key: "left" }, isLoading ? [1, 2, 3].map((key) => import_react58.default.createElement(IconPlaceholder, { key })) : import_react58.default.createElement(import_react58.default.Fragment, null, onReloadStory && import_react58.default.createElement(
    Button,
    {
      padding: "small",
      variant: "ghost",
    ...
    import_react58.default.createElement(SyncIcon, null)
  ), import_react58.default.createElement(
    Button,
    {
      padding: "small",
...
var Preview = ({
  ...
  let [expanded, setExpanded] = (0, import_react27.useState)(isExpanded), [copied, setCopied] = (0, import_react27.useState)(null), [scale, setScale] = (0, import_react27.useState)(1), additionalActionItems = (0, import_react27.useMemo)(
    ...
    let { createCopyToClipboardFunction } = await import("./components-O5BPEDNR.js");
  ...
  ), import_react27.default.createElement(Button, { lang: "en", ariaLabel: false, variant: "ghost", onClick: handleCopyCode }, import_react27.default.createElement(CopyIcon, null), " ", copied ?? "Copy code")), additionalActionItems.map(
    ({ title, ariaLabel, className: className2, onClick, disabled }, index) => import_react27.default.createElement(
      Button,
      {
        key: index,
...
var TabbedArgsTable = ({ tabs, ...props }) => {
  ...
  let tabsFromEntries = entries.map(([label, table], index) => {
    ...
    return {
      ...
      title: label,
      children: import_react59.default.createElement(ArgsTable, { inTabPanel: true, ...table, ...argsTableProps })
    };
  });
...
var Title2 = ({ headingId, title }) => typeof title == "string" || !title ? import_react63.default.createElement(
  Heading,
  {
    as: "h2",
    id: headingId,
...
) : import_react63.default.createElement("div", { id: headingId }, title);
var TableOfContents = ({
  title,
  disable,
  headingSelector,
...
function useSyncExternalStoreShim(subscribe, getSnapshot) {
  let value = getSnapshot(), [{ inst }, forceUpdate] = (0, import_react67.useState)({ inst: { value, getSnapshot } });
  return (0, import_react67.useLayoutEffect)(() => {
    inst.value = value, inst.getSnapshot = getSnapshot, didSnapshotChange(inst) && forceUpdate({ inst });
  }, [subscribe, value, getSnapshot]), (0, import_react67.useEffect)(() => (didSnapshotChange(inst) && forceUpdate({ inst }), subscribe(() => {
...
function useQuerySubscription(cacheKey, query, input, selector) {
  var _a;
  let cache = (0, import_react66.useRef)(void 0);
  (((_a = cache.current) == null ? void 0 : _a.key) !== cacheKey || cache.current.selector !== selector) && (cache.current = {
    key: cacheKey,
    selector,
    state: selector ? seedQueryState(query, input, selector) : seedQueryState(query, input)
  });
  let inputRef = (0, import_react66.useRef)(input);
  inputRef.current = input;
  let subscribe = (0, import_react66.useCallback)(
    (listener) => {
  ...
  ), getSnapshot = (0, import_react66.useCallback)(() => cache.current.state, []);
  return useSyncExternalStoreShim(subscribe, getSnapshot);
}
function useServiceDocgen(id) {
  let service = (0, import_preview_api2.getService)("core/docgen");
...
var useOf = (moduleExportOrType, validTypes) => (0, import_react68.useContext)(DocsContext).resolveOf(moduleExportOrType, validTypes);
...
function useResolveArgTypes(props) {
  ...
  let { of } = props;
  if ("of" in props && of === void 0)
    throw new import_preview_errors2.InvalidBlockOfPropError();
  let context = (0, import_react65.useContext)(DocsContext), resolved = useOf(of || "meta"), resolvedArgTypes;
  ...
  let argTypesParameters = ((_b = (_a = resolvedArgTypes.parameters) == null ? void 0 : _a.docs) == null ? void 0 : _b.argTypes) || {};
  return {
    ...resolvedArgTypes,
    filterProps: {
...
function renderArgTypesTables({
  ...
  if (Object.keys(subcomponentRows).length === 0)
    return import_react65.default.createElement(ArgsTable, { rows: filteredMainRows, sort, docsLang });
  let tabs = {
  ...
  return import_react65.default.createElement(TabbedArgsTable, { tabs, sort, docsLang });
}
var LegacyArgTypes = (props) => {
  ...
  return argTypes ? renderArgTypesTables({
    ...
    docsLang: (_a = parameters == null ? void 0 : parameters.docs) == null ? void 0 : _a.lang,
    ...filterProps
  }) : null;
};
var DocgenServiceArgTypes = (props) => {
  ...
  return isInitialLoading ? import_react65.default.createElement(ArgsTable, { isLoading: true }) : serviceRows ? renderArgTypesTables({
...
var ArgTypesImpl = (props) => {
  var _a;
  return ((_a = globalThis.FEATURES) == null ? void 0 : _a.experimentalDocgenServer) ? import_react65.default.createElement(DocgenServiceArgTypes, { ...props }) : import_react65.default.createElement(LegacyArgTypes, { ...props });
};
...
var SourceContext = (0, import_react71.createContext)({ sources: {} });
var UNKNOWN_ARGS_HASH = "--unknown--";
var SourceContainer = ({
  children,
  channel
}) => {
  let [sources, setSources] = (0, import_react71.useState)({});
  ...
  }, []), import_react71.default.createElement(SourceContext.Provider, { value: { sources } }, children);
};
function useServiceStory(storyId, selector) {
  let componentId = storyId.split("--")[0], service = (0, import_preview_api3.getService)("core/story-docs"), boundSelector = (0, import_react72.useCallback)(
...
function useTransformCode(source, transform, storyContext) {
  let [transformedCode, setTransformedCode] = (0, import_react73.useState)("Transforming..."), transformed = transform ? transform == null ? void 0 : transform(source, storyContext) : source;
...
var useCode = ({
  ...
  var _a;
  let parameters = storyContext.parameters ?? {}, { __isArgsStory: isArgsStory } = parameters, sourceParameters = ((_a = parameters.docs) == null ? void 0 : _a.source) || {}, type = typeFromProps || sourceParameters.type || SourceType.AUTO, staticSnippet = serviceSnippet || snippet, code = (
    /* if user has explicitly set this as dynamic, use snippet */
    type === SourceType.DYNAMIC || // if this is an args story and there's a snippet
    type === SourceType.AUTO && staticSnippet && isArgsStory ? staticSnippet : sourceParameters.originalSource || ""
...
var useSourceProps = (props, docsContext, sourceContext, serviceSnippet = "") => {
  var _a, _b;
  let { of } = props, story = (0, import_react70.useMemo)(() => {
    if (of)
  ...
  if ("of" in props && of === void 0)
    throw new import_preview_errors4.InvalidBlockOfPropError();
  ...
  return props.code === void 0 && !story ? {
...
var SourceWithStoryDocsSnippet = ({ storyId, docsContext, sourceContext, ...props }) => {
  ...
  return import_react70.default.createElement(Source, { ...sourceProps });
};
var SourceWithStorySnippet = (props) => {
  var _a;
  let { of } = props, sourceContext = (0, import_react70.useContext)(SourceContext), docsContext = (0, import_react70.useContext)(DocsContext), story = (0, import_react70.useMemo)(() => {
    if (of)
      return docsContext.resolveOf(of, ["story"]).story;
    try {
      return docsContext.storyById();
  ...
  if (((_a = globalThis.FEATURES) == null ? void 0 : _a.experimentalDocgenServer) && (story == null ? void 0 : story.id))
...
var CanvasImpl = (props) => {
  ...
  return import_react69.default.createElement(
    ...
    import_react69.default.createElement(Story2, { of: of || story.moduleExport, meta: props.meta, ...props.story })
  );
};
...
var useArgsIfDefined = (story, context) => {
  let storyContext = story ? context.getStoryContext(story) : { args: {} }, { id: storyId } = story || { id: "none" }, [args, setArgs] = (0, import_react75.useState)(storyContext.args);
  (0, import_react75.useEffect)(() => {
    let onArgsUpdated = (changed) => {
      changed.storyId === storyId && setArgs(changed.args);
    };
    return context.channel.on(import_core_events3.STORY_ARGS_UPDATED, onArgsUpdated), () => context.channel.off(import_core_events3.STORY_ARGS_UPDATED, onArgsUpdated);
  }, [storyId, context.channel]);
  let updateArgs = (0, import_react75.useCallback)(
    (updatedArgs) => context.channel.emit(import_core_events3.UPDATE_STORY_ARGS, { storyId, updatedArgs }),
    [storyId, context.channel]
  ), resetArgs = (0, import_react75.useCallback)(
    (argNames) => context.channel.emit(import_core_events3.RESET_STORY_ARGS, { storyId, argNames }),
    [storyId, context.channel]
  );
  return story && [args, updateArgs, resetArgs];
};
var useGlobals = (story, context) => {
  let storyContext = context.getStoryContext(story), [globals, setGlobals] = (0, import_react76.useState)(storyContext.globals);
  return (0, import_react76.useEffect)(() => {
    let onGlobalsUpdated = (changed) => {
      setGlobals(changed.globals);
    };
    return context.channel.on(import_core_events4.GLOBALS_UPDATED, onGlobalsUpdated), () => context.channel.off(import_core_events4.GLOBALS_UPDATED, onGlobalsUpdated);
  }, [context.channel]), [globals];
};
var usePrimaryStory = () => {
  let context = (0, import_react77.useContext)(DocsContext), stories = context.componentStories();
  return context.filterByAutodocs === false ? stories[0] : stories.find((story) => story.tags.includes(import_preview_api5.Tag.AUTODOCS));
};
function getControlsFilterProps(story, props) {
  var _a;
  let controlsParameters = ((_a = story.parameters.docs) == null ? void 0 : _a.controls) || {};
  return {
...
var ControlsTables = ({
  ...
  let filteredMainRows = (0, import_preview_api4.filterArgTypes)(mainRows, include, exclude);
  if (Object.keys(subcomponentRows).length === 0)
    return Object.keys(filteredMainRows).length > 0 || Object.keys(args).length > 0 ? import_react74.default.createElement(
      ArgsTable,
      {
        storyId,
        controlsId,
  ...
  let tabs = {
    ...
    ...Object.fromEntries(
      Object.entries(subcomponentRows).map(([key, rows]) => [
        key,
        {
          rows: (0, import_preview_api4.filterArgTypes)(rows, include, exclude),
          sort
        }
      ])
    )
...
var LegacyControls = ({ story, context, ...props }) => {
  ...
  return argTypes ? import_react74.default.createElement(
    ControlsTables,
    {
...
var DocgenServiceControls = ({ story, context, ...props }) => {
  ...
  return isInitialLoading ? import_react74.default.createElement(ArgsTable, { isLoading: true }) : serviceRows ? import_react74.default.createElement(
    ControlsTables,
    {
      mainName: getComponentName(component) ?? serviceRows.serviceComponentName,
      mainRows: serviceRows.mainRows,
...
var ControlsImpl = (props) => {
  var _a;
  let { of } = props, context = (0, import_react74.useContext)(DocsContext), primaryStory = usePrimaryStory(), story = of ? context.resolveOf(of, ["story"]).story : primaryStory;
  if (!story)
    return null;
  let storyProps = { ...props, story, context };
  return ((_a = globalThis.FEATURES) == null ? void 0 : _a.experimentalDocgenServer) ? import_react74.default.createElement(DocgenServiceControls, { ...storyProps }) : import_react74.default.createElement(LegacyControls, { ...storyProps });
};
...
var AddContext = (props) => {
  let { children, ...rest } = props, parentContext = import_react80.default.useContext(DocsContext);
  return import_react80.default.createElement(DocsContext.Provider, { value: { ...parentContext, ...rest } }, children);
};
var CodeOrSourceMdx = ({
  className,
  children,
  ...
  if (typeof className != "string" && (typeof children != "string" || !children.match(/[\n\r]/g)))
    return import_react80.default.createElement(Code, null, children);
...
function navigate(context, url) {
  context.channel.emit(import_core_events5.NAVIGATE_URL, url);
}
var A2 = components2.a;
var AnchorInPage = ({ hash, children }) => {
  let context = (0, import_react80.useContext)(DocsContext);
  return import_react80.default.createElement(
    A2,
    {
      href: hash,
...
var AnchorMdx = (props) => {
  let { href, target, children, ...rest } = props, context = (0, import_react80.useContext)(DocsContext);
  return !href || target === "_blank" || /^https?:\/\//.test(href) ? import_react80.default.createElement(A2, { ...props }) : href.startsWith("#") ? import_react80.default.createElement(AnchorInPage, { hash: href }, children) : import_react80.default.createElement(
    A2,
    {
      href,
      onClick: (event) => {
...
var HeaderWithOcticonAnchor = ({
  ...
  let context = (0, import_react80.useContext)(DocsContext), OcticonHeader = OcticonHeaders[as], hash = `#${id}`;
  return import_react80.default.createElement(OcticonHeader, { id, ...rest }, import_react80.default.createElement(OcticonAlignmentWrapper, { className: "sb-unstyled" }, import_react80.default.createElement(OcticonAnchorWrapper, null, import_react80.default.createElement(
    Button,
    {
      asChild: true,
      variant: "ghost",
    ...
    import_react80.default.createElement(
      ...
      import_react80.default.createElement(LinkIcon, null)
    )
  )), children));
};
var HeaderMdx = (props) => {
  ...
  if (id)
    return import_react80.default.createElement(HeaderWithOcticonAnchor, { as, id, ...rest }, children);
  let Component4 = as, { as: omittedAs, ...withoutAs } = props;
  return import_react80.default.createElement(Component4, { ...nameSpaceClassNames(withoutAs, as) });
};
var HeadersMdx = SUPPORTED_MDX_HEADERS.reduce(
  (acc, headerType) => ({
    ...acc,
    // @ts-expect-error (Converted from ts-ignore)
    [headerType]: (props) => import_react80.default.createElement(HeaderMdx, { as: headerType, ...props })
  }),
  {}
);
...
var getDescriptionFromResolvedOf = (resolvedOf, serviceComponentDescription, storyDocsDescription) => {
  ...
  switch (resolvedOf.type) {
    case "story": {
      let storyDescription = (_b = (_a = resolvedOf.story.parameters.docs) == null ? void 0 : _a.description) == null ? void 0 : _b.story;
...
var DescriptionBody = ({ resolvedOf, serviceComponentDescription, lang, storyDocsDescription }) => {
  ...
  return markdown ? import_react78.default.createElement(Markdown, { lang }, markdown) : null;
};
var DescriptionStoryWithServices = ({ resolvedOf }) => {
  var _a, _b;
  let storyDocsDescription = (_a = useServiceStoryDoc(resolvedOf.story.id).data) == null ? void 0 : _a.description, lang = ((_b = resolvedOf.story.parameters.docs) == null ? void 0 : _b.lang) || "en";
...
var DescriptionComponentWithServices = ({ resolvedOf, componentId }) => {
  var _a, _b, _c, _d;
  let serviceComponentDescription = ((_a = useServiceDocgen(componentId).data) == null ? void 0 : _a.description) || void 0, lang = resolvedOf.type === "meta" ? ((_b = resolvedOf.preparedMeta.parameters.docs) == null ? void 0 : _b.lang) || "en" : ((_d = (_c = resolvedOf.projectAnnotations.parameters) == null ? void 0 : _c.docs) == null ? void 0 : _d.lang) || "en";
  return import_react78.default.createElement(
    DescriptionBody,
    {
      resolvedOf,
...
var DescriptionImpl = (props) => {
  var _a, _b, _c;
  let { of } = props, context = (0, import_react78.useContext)(DocsContext);
  if ("of" in props && of === void 0)
    throw new import_preview_errors5.InvalidBlockOfPropError();
  let resolvedOf = useOf(of || "meta");
  if ((_a = globalThis.FEATURES) == null ? void 0 : _a.experimentalDocgenServer) {
    if (resolvedOf.type === "story")
      return import_react78.default.createElement(DescriptionStoryWithServices, { resolvedOf });
    let componentId = resolvedOf.type === "meta" ? resolvedOf.preparedMeta.componentId : context.getComponentId(resolvedOf.component);
    if (componentId)
      return import_react78.default.createElement(DescriptionComponentWithServices, { resolvedOf, componentId });
  }
  let lang = ((_c = (_b = resolvedOf.type === "story" ? resolvedOf.story.parameters : resolvedOf.type === "meta" ? resolvedOf.preparedMeta.parameters : resolvedOf.projectAnnotations.parameters) == null ? void 0 : _b.docs) == null ? void 0 : _c.lang) || "en";
  return import_react78.default.createElement(DescriptionBody, { resolvedOf, lang });
};
...
var DocsSluggerContext = (0, import_react83.createContext)(
  null
);
...
var DocsContainer = ({
  ...
  var _a, _b, _c, _d, _e2, _f, _g, _h;
  let slugger = (0, import_react82.useMemo)(() => createDocsSlugger(), []), toc, lang;
  try {
    let metaParameters = context.resolveOf("meta", ["meta"]).preparedMeta.parameters;
    toc = (_a = metaParameters == null ? void 0 : metaParameters.docs) == null ? void 0 : _a.toc, lang = ((_b = metaParameters == null ? void 0 : metaParameters.docs) == null ? void 0 : _b.lang) || "en";
  } catch {
    toc = (_e2 = (_d = (_c = context == null ? void 0 : context.projectAnnotations) == null ? void 0 : _c.parameters) == null ? void 0 : _d.docs) == null ? void 0 : _e2.toc, lang = ((_h = (_g = (_f = context == null ? void 0 : context.projectAnnotations) == null ? void 0 : _f.parameters) == null ? void 0 : _g.docs) == null ? void 0 : _h.lang) || "en";
  }
  ...
  }), import_react82.default.createElement(DocsSluggerContext.Provider, { value: slugger }, import_react82.default.createElement(DocsContext.Provider, { value: context }, import_react82.default.createElement(SourceContainer, { channel: context.channel }, import_react82.default.createElement(ThemeProvider, { theme: ensure(theme) }, import_react82.default.createElement(
    DocsPageWrapper,
    {
      lang,
      toc: toc ? import_react82.default.createElement(
        TableOfContents,
        {
...
var HeadingImpl = ({
  ...
  if (disableAnchor || typeof children != "string")
    return import_react88.default.createElement(H2, null, children);
  let tagID = (import_react88.default.useContext(DocsSluggerContext) ?? slugs).slug(children.toLowerCase());
  return import_react88.default.createElement(HeaderMdx, { as: "h2", id: tagID, ...props }, children);
};
var Heading2 = withMdxComponentOverride("Heading", HeadingImpl);
var SubheadingImpl = ({ children, disableAnchor }) => {
  if (disableAnchor || typeof children != "string")
    return import_react87.default.createElement(H3, null, children);
  let tagID = (import_react87.default.useContext(DocsSluggerContext) ?? slugs).slug(children.toLowerCase());
  return import_react87.default.createElement(HeaderMdx, { as: "h3", id: tagID }, children);
};
...
var DocsStoryImpl = ({
  ...
  return import_react86.default.createElement(Anchor, { storyId: __primary ? `primary--${story.id}` : story.id }, expanded && import_react86.default.createElement(import_react86.default.Fragment, null, import_react86.default.createElement(Subheading, null, story.name), import_react86.default.createElement(Description2, { of })), import_react86.default.createElement(
    Canvas,
    {
      of,
      withToolbar,
...
var PrimaryImpl = () => {
  ...
  return primaryStory ? import_react85.default.createElement(DocsStory, { of: primaryStory.moduleExport, expanded: false, __primary: true, withToolbar: true }) : null;
};
...
var StoriesImpl = ({ title = "Stories", includePrimary = true }) => {
  var _a, _b, _c;
  let { componentStories, projectAnnotations, getStoryContext } = (0, import_react89.useContext)(DocsContext), stories = componentStories(), filter = (_c = (_b = (_a = projectAnnotations.parameters) == null ? void 0 : _a.docs) == null ? void 0 : _b.stories) == null ? void 0 : _c.filter;
  return filter && (stories = stories.filter((story) => filter(story, getStoryContext(story)))), stories.some((story) => {
    var _a2;
    return (_a2 = story.tags) == null ? void 0 : _a2.includes(import_preview_api6.Tag.AUTODOCS);
  }) && (stories = stories.filter((story) => {
    var _a2;
    return ((_a2 = story.tags) == null ? void 0 : _a2.includes(import_preview_api6.Tag.AUTODOCS)) && !story.usesMount;
  })), includePrimary || (stories = stories.slice(1)), !stories || stories.length === 0 ? null : import_react89.default.createElement(import_react89.default.Fragment, null, typeof title == "string" ? import_react89.default.createElement(StyledHeading, null, title) : title, stories.map(
    (story) => story && import_react89.default.createElement(DocsStory, { key: story.id, of: story.moduleExport, expanded: true, __forceInitialArgs: true })
  ));
};
...
var SubtitleImpl = (props) => {
  ...
  if ("of" in props && of === void 0)
    throw new import_preview_errors6.InvalidBlockOfPropError();
  let preparedMeta;
  try {
  ...
  return content ? import_react90.default.createElement(Subtitle, { className: "sbdocs-subtitle sb-unstyled" }, content) : null;
};
...
var TitleImpl = (props) => {
  ...
  if ("of" in props && of === void 0)
    throw new import_preview_errors7.InvalidBlockOfPropError();
  let preparedMeta;
  try {
    preparedMeta = useOf(of || "meta", ["meta"]).preparedMeta;
  } catch (error) {
  ...
  return content ? import_react91.default.createElement(Title, { className: "sbdocs-title sb-unstyled" }, content) : null;
};
...
var DocsPage = () => {
  ...
  return import_react84.default.createElement(import_react84.default.Fragment, null, import_react84.default.createElement(Title3, null), import_react84.default.createElement(Subtitle2, null), import_react84.default.createElement(Description2, { of: "meta" }), isSingleStory ? import_react84.default.createElement(Description2, { of: "story" }) : null, import_react84.default.createElement(Primary, null), import_react84.default.createElement(Controls3, null), isSingleStory ? null : import_react84.default.createElement(Stories, null));
};
function Docs({
  context,
  docsParameter
  ...
  return import_react81.default.createElement(Container2, { context, theme: docsParameter.theme }, import_react81.default.createElement(Page, null));
}
var ExternalDocsContext = class extends import_preview_api9.DocsContext {
...
var ExternalPreview = class extends import_preview_api8.Preview {
  constructor(projectAnnotations) {
    super((path) => Promise.resolve(this.moduleExportsByImportPath[path]), () => (0, import_preview_api8.composeConfigs)([
...
function usePreview(projectAnnotations) {
  let previewRef = (0, import_react92.useRef)();
...
function ExternalDocs({
  ...
  var _a;
  (0, import_client_logger7.deprecate)("ExternalDocs is deprecated and will be removed in Storybook 11.");
  let projectAnnotations = (0, import_preview_api7.composeConfigs)(projectAnnotationsList), preview2 = usePreview(projectAnnotations), docsParameter = {
    ...(_a = projectAnnotations.parameters) == null ? void 0 : _a.docs,
    page: () => children
  };
  return import_react92.default.createElement(Docs, { docsParameter, context: preview2.docsContext() });
}
var preview;
var ExternalDocsContainer = ({ projectAnnotations, children }) => ((0, import_client_logger8.deprecate)("ExternalDocsContainer is deprecated and will be removed in Storybook 11."), preview || (preview = new ExternalPreview(projectAnnotations)), import_react93.default.createElement(DocsContext.Provider, { value: preview.docsContext() }, import_react93.default.createElement(ThemeProvider, { theme: ensure(themes.light) }, children)));
var Meta = ({ of }) => {
  let context = (0, import_react94.useContext)(DocsContext);
  of && context.referenceMeta(of, true);
  try {
    let primary = context.storyById();
    return import_react94.default.createElement(Anchor, { storyId: primary.id });
  } catch {
    return null;
  }
};
var UnstyledImpl = (props) => import_react95.default.createElement("div", { ...props, className: "sb-unstyled" });
var Unstyled = withMdxComponentOverride("Unstyled", UnstyledImpl);
var WrapperImpl = ({ children }) => import_react96.default.createElement("div", { style: { fontFamily: "sans-serif" } }, children);
...
//# sourceMappingURL=chunk-DYOG4YFK.js.map
