...
function AIComingSoonModal({ onClose }: AIComingSoonModalProps) {
    // 🆕 (دفعة 2.3 — تقرير تشخيص تجربة سطح المكتب): نفس ملاحظة DeleteConfirmModal —
    // مركزي أصلًا، بنستخدم الـ hook بس للأنيميشن.
    ...
    return React.createElement('div', {
        ...
        React.createElement('div', { className: `w-full max-w-sm bg-premium-card border border-white/10 rounded-3xl p-6 ${modalPresentation.panelAnimationClassName} shadow-2xl text-center space-y-4` },
