    ...
    return React.createElement("div", {className:"relative", ref},
        ...
        open && React.createElement("div", {className:"absolute z-[200] top-full mt-2 right-0 bg-premium-card border border-white/10 rounded-2xl shadow-2xl p-4 w-72", style:{fontFamily:"Cairo,sans-serif"}},
            React.createElement("div", {className:"flex items-center justify-between mb-3"},
                ...
                React.createElement("button",{type:"button",onClick:prevMonth,'data-testid':'date-picker-prev-month',className:"w-7 h-7 rounded-lg bg-white/5 text-white flex items-center justify-center text-sm hover:bg-white/10"},"‹")
            ),
            ...
            value && React.createElement("button",{type:"button",onClick:()=>{onChange("");setOpen(false);},'data-testid': clearTestId,className:"mt-3 w-full text-[10px] text-rose-400 font-bold py-1"},"✕ مسح التاريخ")
        )
    );
}
