            ...
            React.createElement('div',{className:"space-y-4 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-3 lg:items-start lg:grid-flow-row-dense"},
                ...
                React.createElement('div',null,
                    ...
                    React.createElement('div',{className:"flex gap-2 items-center"},
                        // 🔢 FIX (طلب مباشر — 11 سبتمبر 2026): "رقم الدعوى" أرقام بس (onlyDigits بدل normalizeArabicDigits وحدها).
                        React.createElement('input',{value:form.caseNum,onChange:(e: React.ChangeEvent<HTMLInputElement>) =>s('caseNum',onlyDigits(e.target.value)),placeholder:"رقم الدعوى",inputMode:"numeric",className:"flex-1 p-3 text-xs rounded-xl border border-white/10 bg-premium-bg text-white placeholder-slate-600 text-center",style:inpStyle,'data-testid':'new-case-number'}),
                ...
                form.date
                    ? React.createElement('div',{className:"grid grid-cols-2 gap-2 items-start lg:col-span-2"},
                        React.createElement(DatePicker,{label:"تاريخ الجلسة القادمة",value:form.date,onChange:(v: string) =>s("date",v),required:true,testId:'new-case-date-trigger',dayTestId:'new-case-date-day'}),
