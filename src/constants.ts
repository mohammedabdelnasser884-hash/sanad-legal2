...
const I={
    ...
    // أيقونة "مجلدات فوق بعض" — بتتحط في كارت المجلد الفرعي عشان تتفرّق
    // بصريًا عن أيقونة المجلد العادية (Folder) من أول وهلة، مش بس باللون.
    FolderStack:({className="w-5 h-5"}:{className?: string})=>React.createElement('svg',{className,fill:"none",viewBox:"0 0 24 24",strokeWidth:"1.5",stroke:"currentColor"},
      React.createElement('path',{opacity:"0.45",strokeLinecap:"round",strokeLinejoin:"round",d:"M2.75 9.75v-.5A1.75 1.75 0 0 1 4.5 7.5h2.02c.245 0 .483.088.67.247l2.183 1.87a.75.75 0 0 0 .487.183h5.39a1.75 1.75 0 0 1 1.75 1.75v.2"}),
      React.createElement('path',{strokeLinecap:"round",strokeLinejoin:"round",d:"M2.25 13.75V13A2.25 2.25 0 0 1 4.5 10.75h1.52c.314 0 .62.113.86.317l2.683 2.19a.75.75 0 0 0 .47.163h6.417a2.25 2.25 0 0 1 2.25 2.25v.5m-18 0v3.25a2.25 2.25 0 0 0 2.25 2.25h13.5a2.25 2.25 0 0 0 2.25-2.25v-3.25m-18 0A2.25 2.25 0 0 1 4.5 13.5h13a2.25 2.25 0 0 1 2.25 2.5"})),
    ...
    // ⚡ NEW (بحث صوتي، سبتمبر 2026): أيقونة مايك بسيطة لزرار "بحث صوتي" جوه UniversalSearchModal.
    Mic:({className="w-5 h-5"}:{className?: string})=>React.createElement('svg',{className,fill:"none",viewBox:"0 0 24 24",strokeWidth:"1.5",stroke:"currentColor"},React.createElement('path',{strokeLinecap:"round",strokeLinejoin:"round",d:"M12 18.75a6 6 0 0 0 6-6v-1.5m-6 7.5a6 6 0 0 1-6-6v-1.5m6 7.5v3.75m-3.75 0h7.5M12 15.75a3 3 0 0 1-3-3V4.5a3 3 0 1 1 6 0v8.25a3 3 0 0 1-3 3Z"})),
    ...
    // أيقونة "قائمة الحساب" (نقط رأسية / kebab) — مقصودة عمدًا مختلفة شكليًا عن
    // زرار طي/فتح DesktopSidebar (اللي بيستخدم ChevronLeft/ChevronRight) وعن أي
    // أيقونة تنقل تانية، عشان تتفادى اللبس اللي اتوصف في تقرير تشخيص الديسكتوب
    // (بند 4) بين "هامبرغر قائمة الحساب" في AppHeader و"زرار السايدبار".
    MoreVertical:({className="w-4 h-4"}:{className?: string})=>React.createElement('svg',{className,viewBox:"0 0 24 24",fill:"currentColor"},
        React.createElement('circle',{cx:"12",cy:"5",r:"1.75"}),
        React.createElement('circle',{cx:"12",cy:"12",r:"1.75"}),
        React.createElement('circle',{cx:"12",cy:"19",r:"1.75"})
    ),
    ChevronRight:({className="w-5 h-5"}:{className?: string})=>React.createElement('svg',{className,fill:"none",viewBox:"0 0 24 24",strokeWidth:"2",stroke:"currentColor"},React.createElement('path',{strokeLinecap:"round",strokeLinejoin:"round",d:"M8.25 4.5l7.5 7.5-7.5 7.5"})),
